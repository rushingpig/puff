package net.blissmall.puff.core.persistence.paging;
...
public class Pagination<T> {
	 ...
	 * @param count 数据条数
	 */
	public Pagination(int pageNo, int pageSize, long count) {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			...
			sb.append("<li><a href=\"javascript:\" onclick=\"").append(funcName).append("(").append(prev).append(",").append(pageSize).append(",'").append(funcParam).append("');\">&#171; 上一页</a></li>\n");
		}
...
//		Pagination<String> p = new Pagination<String>(3, 3);
...
//	 */
//	static void setSpringPage(org.springframework.data.domain.Pagination<T> page){
