...
import net.blissmall.puff.service.mapper.category.CategoryMapper;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<ProductVo> getProductList(BussProduct bussProduct, DictRegionalism dictRegionalism) {
        return categoryMapper.getProductList(bussProduct.getCategoryId(), dictRegionalism.getId());
    }

    @Override
    public List<BussProduct> getProductList(BussProduct bussProduct) {
        return categoryMapper.select(bussProduct);
    }
}
